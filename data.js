const quotes = [
  {
    ...
    person: 'Ellen Ullman',
    context: 'Life in Code: A Personal History of Technology (book)',
    year: 2017
  },
  {
    id: 2,
    ...
    person: 'u/computery',
    context: 'Reddit - r/ProgrammerHumor (website)',
    year: 2016
  },
  {
    id: 3,
    ...
    person: 'Grace Hopper',
    context: '"The Future: Hardware, Software, and People", in \'Carver\' (article in a book)',
    year: 1983
  },
  {
    id: 4,
    ...
    person: 'C-3PO',
    context: 'Star Wars: Episode V - The Empire Strikes Back (film)',
    year: 1980
  },
  {
    id: 5,
    ...
    context: '"I said that after a frustrating attempt to use a "feature-rich" telephone sometime around 1990." (https://www.stroustrup.com/quotes.html)',
    year: 1990
  },
  {
    id: 6,
    ...
    person: 'Ada Lovelace',
    context: 'Unclear, but presumably around the time that she translated and contributed to Luigi Menabrea\'s article on Charles Babbage\'s newest machine, the "Analytic Engine"',
    year: 'circa 1840'
  },
  {
    id: 7,
    ...
    person: 'Jeremy Keith',
    context: 'Resilient Web Design (book)',
    year: 2009
  },
  {
    id: 8,
    ...
    person: 'Grace Hopper',
    context: 'Computerworld (periodical)',
    year: 1976
  },
  {
    id: 9,
    ...
    context: 'Memoirs of a Computer Pioneer (book)',
    year: 1985
  },
  {
    id: 10,
    ...
    person: 'Bill Gates',
    context: 'Introducing the "Hour of Code" (code challenge designed to encourage people to begin coding)',
    year: 2013
  },
  {
    id: 11,
    ...
    person: 'Fred Brooks',
    context: 'The Mythical Man-Month (book)',
    year: 1975
  },
  {
    id: 12,
    ...
    context: 'Thirty Minutes Over Tokyo (episode)',
    year: 1999
  },
  {
    id: 13,
    ...
    context: '(in response to a comment at a lecture that it is impossible for a machine to think)',
    year: 1948
  },
];
